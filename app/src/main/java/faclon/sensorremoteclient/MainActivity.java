...
import faclon.sensorremoteclient.utils.CrossfadeWrapper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "Stop Touching Me!!", Snackbar.LENGTH_LONG)
                        .setAction("Action", null).show();
            }
        });

        final IProfile profile = new ProfileDrawerItem().withName("Utkarsh Srivastava").withEmail("utkarshnarain@gmail.com").withIcon("https://lh5.googleusercontent.com/-5W_F7QEp0XY/AAAAAAAAAAI/AAAAAAAAI5Q/9wKmGQ6IRt8/photo.jpg?sz=328");
                ...
                .withOnAccountHeaderListener(new AccountHeader.OnAccountHeaderListener() {
                    ...
                    public boolean onProfileChanged(View view, IProfile profile, boolean current) {
                        ...
                        if (profile instanceof IDrawerItem && ((IDrawerItem) profile).getIdentifier() == PROFILE_SETTING) {
                            IProfile newProfile = new ProfileDrawerItem().withNameShown(true).withName("Utkarsh Srivastava").withEmail("utkarshnarain@gmail.com").withIcon(getResources().getDrawable(R.drawable.profile));
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        if (drawerItem instanceof Nameable) {
                            Toast.makeText(MainActivity.this, ((Nameable) drawerItem).getName().getText(MainActivity.this), Toast.LENGTH_LONG).show();
                        }
                        return false;
                    }
                })
